...
const OBJECTIONS = [
  {
    ...
    back: "17€, c'est le prix d'un déjeuner. Le coût de rester en mode survie émotionnelle, à garder ses distances, à partir avant d'être blessée, lui, il est bien plus élevé."
  },
  {
    front: "J'ai déjà tout essayé.",
    back: "T'as peut-être essayé d'être encore plus forte. Pas d'apprendre à rester sans te fermer. C'est une méthode concrète, pas un texte motivationnel."
  },
  {
    front: "Je n'ai pas le temps.",
    back: "Pour une Louve, « pas le temps » veut souvent dire trop de charge mentale, trop de contrôle, trop de « je gère ». 10 minutes suffisent. Cet e-book ne te prend pas du temps. Il t'en rend."
  },
  {
    front: "Je connais déjà mes schémas.",
    back: "Connaître ses mécanismes de défense et comprendre comment les dépasser sans se perdre, c'est pas la même chose. La deuxième, c'est ce qui change vraiment."
  },
]
...
const QUIZ_ITEMS = [
  "Tu es très autonome… mais tu te sens souvent seule à l'intérieur, comme si personne ne pouvait vraiment te rejoindre là où tu es.",
  "Tu as du mal à demander de l'aide ou du soutien, parce que tu as appris à tout porter toi-même (et à ne rien montrer).",
  "Quand quelqu'un se rapproche, tu deviens hyper vigilante : tu observes, tu analyses, tu anticipes… et tu gardes une distance « au cas où ».",
  "Tu dis « ça va » même quand ça ne va pas, parce que tu ne veux pas être un poids, ni « trop ».",
  "Tu as l'impression de devoir rester forte en permanence, et tu ne sais plus comment te détendre dans une relation.",
  "Tu quittes (ou tu te fermes) avant d'être blessée : tu préfères contrôler la distance plutôt que risquer de t'attacher.",
  "Quand quelqu'un est stable et présent, une partie de toi doute : tu te demandes si tu vas t'ennuyer… ou si c'est « trop simple pour être vrai ».",
  "Tu t'es déjà surprise à penser : « Au fond, le problème… c'est moi ? » et tu ressens un mélange de culpabilité, de fatigue et d'incompréhension.",
]
...
const TOC_ITEMS = [
  "Quand ton corps raconte ton histoire avant toi",
  "Pourquoi la proximité te secoue plus que les autres",
  "Ce que tu protèges vraiment",
  "Ton vrai rythme : comment tu t'attaches vraiment",
  "Les hommes que tu attires (et pourquoi)",
  "Le schéma que tu répètes (et comment tu t'y enfermes)",
  "Les hommes qui respectent ton rythme",
...
export default function LouvePage() {
  ...
  async function handlePay() {
    ...
    try {
      const res = await fetch(WORKER_URL + '/create-payment-intent', {
        ...
        body: JSON.stringify({ profil: 'louve', email, bump: addBump, bump2: addBump2 })
      })
    ...
    <>
      <div className="card">
        ...
        <div className="narrative fade-section">
          ...
          <p>Tu es forte, autonome et intelligente. De l'extérieur, on dirait que tu n'as besoin de personne et que tout est sous contrôle.</p>
          <p>Mais à l'intérieur, tu ressens souvent cette fatigue d'être « la forte » et toujours sur tes gardes.</p>
          <p>Tu dis souvent : « Ça va. Je me débrouille seule. » Mais parfois, cette pensée apparaît : <em>« Est-ce que quelqu'un restera un jour… sans que j'aie besoin de me protéger ? »</em></p>
          <p>Quand quelqu'un commence à se rapprocher, <strong>ton radar s'active.</strong> Tu observes, tu analyses et tu gardes tes distances.</p>
          <p>Quand ça devient sérieux, quelque chose en toi se referme. Pas parce que tu ne veux pas aimer, mais parce que tu as appris que s'ouvrir fait mal.</p>
          <p>Tu préfères partir la première plutôt que d'être blessée. Contrôler plutôt que te dévoiler. Être forte plutôt que vulnérable.</p>
          <p>Et parfois tu regardes les autres couples et tu penses : <em>« Comment font-ils pour que ce soit si simple ? »</em></p>
          <p><strong>Le problème, ce n'est pas toi.</strong></p>
          <p>C'est que personne ne t'a appris comment aimer sans te perdre. Comment rester ouverte sans te mettre en danger. Comment laisser quelqu'un entrer sans te fermer.</p>
          <p>Une fois que tu comprends ça, vraiment, quelque chose change. Tu ne deviens pas naïve. Tu ne renonces pas à ta force. Tu deviens simplement <em>plus libre.</em></p>
        ...
        <div className="inaction-section fade-section">
          ...
          <div className="inaction-list">
            {[
              "Tu continueras à garder tes distances, même avec des personnes bien intentionnées.",
              "Tu continueras à partir trop tôt, par peur de t'attacher.",
              "Tu continueras à confondre contrôle et sécurité.",
              "Tu continueras à cacher tes besoins en disant : « Ça va, je gère. »",
              "Tu continueras à choisir la solitude plutôt que le risque d'aimer.",
              "Et ton cœur restera protégé, mais aussi privé de vraie connexion.",
            ].map((item, i) => (
          ...
          <p className="inaction-conclusion">Le plus difficile, c'est que ça s'installe doucement. Tu t'habitues à être forte, à ne pas demander, à ne pas attendre. Pas parce que tu es froide, mais parce que personne ne t'a appris comment aimer sans te perdre.</p>
            ...
            <div className="book-pages">
              ...
              >
                ...
                {[
                  ...
                  "Tu as l'impression de toujours devoir être forte dans tes relations.",
                  "Tu as du mal à te laisser vraiment approcher, même quand quelqu'un est bien intentionné.",
                  "Tu te fermes ou tu prends de la distance quand ça devient sérieux.",
                  "Tu caches souvent tes besoins derrière un « ça va, je gère ».",
                  "Tu veux construire une relation sans perdre ton indépendance.",
                ].map((text, i) => (
              ...
              >
                <div className="book-face-front">
                  <div className="book-cover-top">
                    ...
                    <h3 className="book-cover-main-title">Aimer sans<br/>se perdre</h3>
                  </div>
                  <div className="book-cover-divider" />
                  <p className="book-cover-subtitle">Ce livre n'est pas fait pour toi si…</p>
                  {[
                    "Tu penses que tu n'as rien à changer et que le problème vient toujours des autres.",
                    "Tu refuses de regarder tes mécanismes de défense.",
                    "Tu préfères rester dans ta zone de confort, même si elle est solitaire.",
                    "Tu veux rester dans le contrôle plutôt que d'apprendre à faire confiance.",
                  ].map((text, i) => (
                    <div key={i} className="book-item">
                      <span className="book-item-icon">✕</span>
                      <span className="book-item-text">{text}</span>
                ...
                <div className="book-face-back">
                  <div className="book-face-back-content">
                    <p className="book-testimonial-text">"J'ai enfin compris pourquoi je partais toujours avant que ça devienne sérieux. Ce livre m'a appris à rester."</p>
                    <p className="book-testimonial-author">Sarah, 33 ans</p>
                  </div>
                </div>
              </div>
        ...
        <div className="benefits-section fade-section">
          ...
          {[
            "Tu arrêteras de vivre en mode « survie émotionnelle » et tu apprendras à te détendre, à faire confiance progressivement, sans te forcer ni te fermer.",
            "Tu comprendras pourquoi tu contrôles et comment lâcher sans te perdre, rester forte sans être rigide, t'ouvrir sans être naïve.",
            "Tu repéreras les vraies intentions sans t'hyperprotéger, en lisant la cohérence entre les paroles et les actes.",
            "Tu apprendras à t'attacher sans t'abandonner : rester toi, poser tes limites, exprimer tes besoins, sans peur d'être « trop ».",
          ].map((text, i) => (
            ...
            <div className="abri-right">
              <div className="abri-text-wrapper">
                <div className="abri-text-off">
                  <p>Continuer à <strong>te protéger, garder tes distances, partir avant…</strong></p>
                  <p className="abri-ou">ou tu peux <strong>actionner l'interrupteur…</strong></p>
                </div>
                <div className="abri-text-on">
                  <p>et apprendre à rester sans te perdre, et à aimer sans armure.</p>
                </div>
              </div>
        ...
        <div className="payment-block fade-section" ref={paiementRef} id="paiement">
          ...
          <div className="payment-book-row">
            <div className="payment-book-details">
              <h2>{addBump && addBump2 ? 'Pack 3 e-books' : addBump ? 'Aimer sans se perdre + Applis de rencontre' : addBump2 ? 'Aimer sans se perdre + Tu t\'es encore fait ghoster' : 'Aimer sans se perdre'}</h2>
              <p className="offer-sub">{(addBump || addBump2) ? `${1 + (addBump ? 1 : 0) + (addBump2 ? 1 : 0)} e-books · PDF envoyés immédiatement par mail · Mises à jour à vie` : '~160 pages · PDF envoyé immédiatement par mail · Mises à jour à vie'}</p>
            </div>
            <img src="/images/louve.avif" alt="Aimer sans se perdre" className="payment-book-img" width="72" height="113" />
          </div>
        ...
        <div className="fade-section" style={{ marginTop: '72px' }}>
          <div style={{ display: 'flex', gap: '40px', alignItems: 'center', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '240px' }}>
              ...
              <p style={{ marginBottom: '20px' }}>Tu hésites. Tu gardes tes distances même face à une décision. Tu veux être sûre avant de t'engager.</p>
            ...
            <div style={{ flexShrink: 0, display: 'flex', justifyContent: 'center', width: '100%', maxWidth: '280px', margin: '0 auto' }}>
              <div className="iphone">
                ...
                <div className="messages" id="abri-msgs">
                  <div className="row" id="abri-m1" style={{ alignItems: 'flex-end', display: 'none' }}><div className="bubble bubble-u">Il commence à se rapprocher… et j'ai envie de prendre mes distances 😟</div></div>
                  ...
                  <div className="row" id="abri-m3" style={{ alignItems: 'flex-end', display: 'none' }}><div className="bubble bubble-u">Non… ça arrive souvent quand c'est bien 😞</div></div>
                  <div className="row" id="abri-t2" style={{ display: 'none' }}><div className="typing"><span /><span /><span /></div></div>
                  <div className="row" id="abri-m4" style={{ alignItems: 'flex-start', display: 'none' }}><div className="sender">Sofi & Oli 💛</div><div className="bubble bubble-a">Ce réflexe de fuite, c'est une protection. Voilà comment le reconnaître et rester 👇</div></div>
                </div>
