...
export default function QuizPage() {
  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, display: 'flex', justifyContent: 'center', paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 8px)', paddingTop: 10, zIndex: 10, pointerEvents: 'none' }}>
